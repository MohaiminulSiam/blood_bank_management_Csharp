...
namespace blood_bank_management_Csharp.Database
{
    public class DataAccess
    {
        ...
        public static SqlConnection SqlCon
        {
            get
            {
                if (sqlCon == null)
                {
                    sqlCon = new SqlConnection(@"Data Source=DESKTOP-32IK7D6;Initial Catalog=blood_bank_management;Integrated Security=True");
                }
